...
### Selecciono el conjunto de datos que representaré en una visualización con la herramienta Flourish. Los datos corresponden a la encuesta de opinión "Baròmetre" realizada por el "Centre d'Estudis d'Opinió (CEO)" en el periodo de 27 de septiembre al 21 de octubre de 2022. Mi objetivo es mostrar la opinión sociopolítica de los jóvenes en Cataluña (hasta 40 años) teniendo en cuenta variables como el sexo y el sentimiento de discriminación por cuestión de género. Esto, teniendo en cuenta el actual contexto de pospandemia, el conflicto en Ucrania y las próximas elecciones municipales que se celebran este año 2023.
...
# Valoración de la amenaça que supone para su vida el conflicto en Ucrania donde 10 es "Amenaça total" i 0 "Ninguna amenaça"

```{r}
# Valoración de la amenaça que supone el conflicto en Ucrania: Mujeres
...
```{r}
# Valoración de la amenaça que supone el conflicto en Ucrania: Hombres
...
```{r}
# Valoración de la amenaça que supone el conflicto en Ucrania: Personas discriminadas por cuestión de género
...
```{r}
# Valoración de la amenaça que supone el conflicto en Ucrania: Personas no discriminadas por cuestión de género
...
# Valoración de la amenaça que supone para su vida las pandemias donde 10 es "Amenaça total" i 0 "Ninguna amenaça"

```{r}
# Valoración de la amenaça que suponen las pandemias: Mujeres
...
```{r}
# Valoración de la amenaça que suponen las pandemias: Hombres
...
```{r}
# Valoración de la amenaça que suponen las pandemias: Personas discriminadas por cuestión de género
...
```{r}
# Valoración de la amenaça que suponen las pandemias: Personas no discriminadas por cuestión de género
